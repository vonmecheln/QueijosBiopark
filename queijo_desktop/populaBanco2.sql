...
INSERT INTO fermento (nome, marca) VALUES ('Mesofilico old', 'Docina');
INSERT INTO fermento (nome, marca) VALUES ('Mesofilico termofilico', 'Docina');
INSERT INTO fermento (nome, marca) VALUES ('Mesofilico tipo O', 'Docina');
INSERT INTO fermento (nome, marca) VALUES ('Mesofilico +PPR10', 'Docina+Lactopar');

-- Populando tabela Pessoa
INSERT INTO pessoa (nome, endereco, telefone, tipoFiscal, documento, tipoPessoa) VALUES ('Beatriz Durlan', 'Rua Roxo nr 11','45 3333-3333','F', '00000000000','Produtor');
INSERT INTO pessoa (nome, endereco, telefone, tipoFiscal, documento, tipoPessoa) VALUES ('Cirlei Rossi', 'Rua Preto nr 22','45 3333-3333','F', '11111111111','Produtor');
INSERT INTO pessoa (nome, endereco, telefone, tipoFiscal, documento, tipoPessoa) VALUES ('Saul', 'Rua Verde nr 33','45 3333-3333','F', '22222222222','Produtor');
INSERT INTO pessoa (nome, endereco, telefone, tipoFiscal, documento, tipoPessoa) VALUES ('Lovani', 'Rua Amarelo nr 17','45 3333-3333','F', '33333333333','Produtor');
INSERT INTO pessoa (nome, endereco, telefone, tipoFiscal, documento, tipoPessoa) VALUES ('Gilvan', 'Rua Azul nr 98','45 3333-3333','F', '44444444444','Produtor');
INSERT INTO pessoa (nome, endereco, telefone, tipoFiscal, documento, tipoPessoa) VALUES ('Marlova Bombardelli', 'Rua Vermelho nr 20','45 3333-3333','F', '55555555555','Produtor');
INSERT INTO pessoa (nome, endereco, telefone, tipoFiscal, documento, tipoPessoa) VALUES ('Ronaldo', 'Rua Laranja nr 78','45 3333-3333','F', '66666666666','Produtor');
...
INSERT INTO fabricacaoqueijo (receita_id, dataFabricacao, loteQueijo, coleta_id, qtdLeite, tipoLeite, tempoProcessamento, temperaturaProcessamento,temperaturaPreMaturacao, fermento_id, qtdFermento, tempoFermentacao, phMaturacao, temperaturaCoagulacao, qtdClCalcio, qtdCoagulante, tempoCoagulacao, phCorte,phEnformagem, phFinal, dessoragem, temperaturaDessoragem, tipoSalga, dataMaturacao, temperaturaMaturacao, dataLavagem, tipoTratamento, tempoTratamento, qtdPecas,pesoMPecas, observacoes) VALUES (1,'2019-06-27','270919SP',1,30,'Pasteurizado',30,63,36,1,1.5,60,6.81,0,14.4,21,40,6.87,0,0,0,0,'Salmora','2019-06-28',12,'2019-06-29','Outro',60,7,800,'Utilizado 10L de agua aquecida e retirado 15L de soro');

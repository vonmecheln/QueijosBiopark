...
/*
* @author adam_crume customized by Mauda
* http://mauda.com.br/?p=827
 */
...
public class NamedParameterStatement {
    ...
    private final Map<String, List<Integer>> mapPosicoesParametros = new HashMap<>();
     ...
     * @param namedQuery - A query no formato namedQuery
